    ...
    def __call__(self, f):
        ...
        def delay(*args, **kwargs):
            ...
            if kwargs.get('queue') is not None:
                queue = kwargs.pop('queue')     ## If queue is passed in delay() function, it overrides the decorator queue
            elif isinstance(self.queue, str):
        ...
        f.delay = delay
        f.queue = delay     ## Added for compatibility with code that currently uses Flask-RQ2
        return f
